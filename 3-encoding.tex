...
a two-symbol sequence of the form ``\textbf{sX sX},'' where X are integers that may be
...
represented as ``\textbf{sX tX},'' where X are integers that may be the same or
different.  In this scheme, common words and rare words do not share symbols
and each symbol can immediately be identified as common, the first of a rare encoding pair, or the
